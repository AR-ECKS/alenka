              ...
              <div class="tab-content">
                <div class="table-responsive-xl">
                        ...
                        <table class="table table-sm text-sm table-striped" >
                                ...
                                <tr>
                                    <th  >#</th>
                                    <th scope="col" class="px-6 py-3">Cantidad Presentacion</th><th scope="col" class="px-6 py-3">Cantidad Unidad</th><th scope="col" class="px-6 py-3">Materia Prima Id</th>
                                                                        <th >Estado</th>
                            ...
                            @foreach($detalle_despacho as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4">{{ $item->cantidad_presentacion }}</td><td class="px-6 py-4">{{ $item->cantidad_unidad }}</td><td class="px-6 py-4">{{ $item->materia_prima_id }}</td>
                                     <td>
                                                    @if ($item->estado == 1)
                                     ...
                                     @if ($item->estado == 1)
                                      <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('detalle_despacho.show', $item->id) }}" title="View Detalle_despacho"
                                                                class="dropdown-item" data-toggle="tooltip"
                                                                data-placement="top" title="Ver detalles">
                                                                <i class="far fa-eye"> </i> Ver detalles
                                                            </a>

                                                            <a href="{{ route('detalle_despacho.edit', $item->id) }}" title="Edit Detalle_despacho"
                                                                class="dropdown-item" data-toggle="tooltip"
                                                            ...
                                                            <form action="{{ route('detalle_despacho.destroy', $item->id) }}"
