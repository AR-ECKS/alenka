                ...
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        <div class="float-right mt-3">
                         @can('crear_proveedor')
                         <a type="button" class="btn btn-primary text-white" href="{{ route('proveedores.create') }}">
                            <i class="fas fa-database"></i> Nuevo Proveedor
                        </a>
                         @endcan
                        </div>
                        <br><br><br>
                        <div class="tab-content">
                            <div class="table-responsive-xl">
                                <table class="table table-sm text-sm table-striped" id="id">
                                    <thead>
                                        <tr>
                                            <th> # </th>
                                                ...
                                                <td class="td-actions text-right">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <form action="{{ route('proveedores.delete', $item->id) }}"
                                                        ...
                                                        @else
                                                        @can('restaurar_proveedor')

                                                        <a href="{{ route('proveedores.reingresar', $item->id) }}"
