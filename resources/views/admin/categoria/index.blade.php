                ...
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        <div class="float-right mt-3">
                            <a type="button" class="btn btn-primary text-white" href="{{ route('categorias.create') }}">
                                <i class="fas fa-database"></i> Nuevo Categoria
                            </a>
                        </div>
                        <br><br><br>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    @if ($item->estado == 1)
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="{{ route('categorias.show', $item->id) }}"
                                                                    title="View Categorium" class="dropdown-item"
                                                                ...
                                                                <a href="{{ route('categorias.edit', $item->id) }}"
                                                                    title="Edit Categorium" class="dropdown-item"
                                                                    data-toggle="tooltip" data-placement="top"
                                                                    title="Editar">
                                                                ...
                                                                <form action="{{ route('categorias.destroy', $item->id) }}"
                                                        ...
                                                        @else
                                                            <a action="{{ route('categorias.reingresar', $item->id) }}"
